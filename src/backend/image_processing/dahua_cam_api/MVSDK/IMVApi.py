...
if sys.platform == 'win32':
    ...
    if bits == '64bit':
        cwd = os.getcwd()
        print(cwd)
        folder_path = os.path.join(cwd, r'src\backend\image_processing\dahua_cam_api\Runtime\x64\MVSDKmd.dll')
        print(folder_path)
#        C:\Users\malit\OneDrive\Documents\GitHub\2D_optical_vision_mapping\src\backend\image_processing\dahua_cam_api\Runtime\x64\MVSDKmd.dll
        MVSDKdll = WinDLL(folder_path)
    else:
